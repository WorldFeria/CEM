<?php
    ...
    switch ($opc) {
        ...
        case 'asesoresFromStand':
            getMyAdvisersFromStand();
        break;
    ...
    function getMyUnsetAdvisers(){
    
        include("../config/config.php");

        $email_exh = $_REQUEST['email'];
    
/*$query = "SELECT * from adviser, user WHERE email = email2 AND email_exhibitor = '$email' 
            ORDER BY user.first_name DESC;";*/

        $query = "SELECT * from adviser, user WHERE email = email2 AND  email_exhibitor='$email_exh' AND id_stand2 = -1;";
    ...
    function getMyAdvisersFromStand(){
        ...
        $query = "SELECT * from adviser, user WHERE email = email2 AND email_exhibitor = '$email' AND id_stand2 = '$id_stand'
            ORDER BY user.first_name DESC;";
    ...
    function getAllAdvisers(){
        ...
        $query = "SELECT * FROM user, adviser  where id_rol2 = 4 and email = email2 
            ORDER BY user.first_name DESC;";
