...
<body id="body-pd" oncontextmenu='return false' class='snippet-body'>
    ...
    <div class="l-navbar" id="nav-bar" style="padding-top: 8px;">
            ...
            <div>
                ...
                <div id="sidebar_nav" class="nav_list">
                    ...
                    ?>
                        ...
                        <a href="event" class="nav_link"> <i class='bx bxs-calendar-event nav_icon'></i>
                            <span class="nav_name">Eventos</span>
                        </a>
                        ...
                        <!-- <a href="ponentes" class="nav_link"> <i class='bx bx-user-plus nav_icon'></i>
                            <span class="nav_name">Expositores</span>
                        </a>-->

                        <!--<a href="visitors" class="nav_link"> <i class='bx bx-user-plus nav_icon'></i>
                            <span class="nav_name">Visitantes</span>
                        </a>-->

                        <!--<a href="allUsers" class="nav_link"> <i class='bx bx-user-plus nav_icon'></i>
                            <span class=" nav_name">Usuarios</span>
                        </a>
    ...
    ?>
        <script>
            notyf.open({
                type: 'info',
                message: '<b>¡BIENVENIDO! a <i>CEM</i>!</b> <i><?php echo $rolusername; ?></i> - <?php echo  $name . " " . $lastname; ?>.'
            });
        </script>
    <?php
    }
