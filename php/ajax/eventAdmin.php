...
$sql = "SELECT id_evento, nombre_evento, tipo_evento, descripcion_evento, cantidad_pabellones, loby, landing_page, fecha_inicio, fecha_cierre, cantidad_auditorios,link_evento,link_vr,nombre_logo,horario_inicio,horario_cierre FROM evento ORDER BY fecha_inicio DESC;";
        ...
        <div class="row g-0">
            ...
            <div class="col-md-3">
                <div class="card-body">
                    ...
                    <button type='button' class='btn btn-primary edit-lean' title='Administrar Espacios' alt='Administrar Espacios' onclick="get_dataAdmin('<?php echo $idevento ?>');"><i class='bx bx-columns nav_logo-icon'></i></button>
...
<script>
    ...
    function get_dataAdmin(idevento) {
        var idevent = idevento;
        //var nameevent = nombreevento;
        //console.log(nameevent);
        var body = $("html, body");
        body.stop().animate({
            scrollTop: 0
        }, 250);
        $('#page_content').load(`event_editAdmin.php?idevent=${idevent}`);
    }
