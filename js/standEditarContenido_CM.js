...
$("#formulario_borrar_archivo").on("submit", function (event) {
  ...
  $('#reload').click(function(){
    ...
    $('#page_content').load(`tabla_stand_pub_CM.php?cod_stand=${codigo_stand}`);
...
$('.btn-borrar_gimg_10').click(function () {
  ...
  document.getElementById("imagen_mostrada_real_eli").src = direccion_archivo + "imgGaleria10.jpg";
  $('#nombre_archivo_borrar').val('imgGaleria10.jpg');//SE ENVÍA AL FORMULARIO

});
$('.btn-borrar_gimg_11').click(function () {
  ...
  document.getElementById("imagen_mostrada_real_eli").src = direccion_archivo + "imgGaleria11.jpg";
  $('#nombre_archivo_borrar').val('imgGaleria11.jpg');//SE ENVÍA AL FORMULARIO

});
$('.btn-borrar_gimg_12').click(function () {
  ...
  document.getElementById("imagen_mostrada_real_eli").src = direccion_archivo + "imgGaleria12.jpg";
  $('#nombre_archivo_borrar').val('imgGaleria12.jpg');//SE ENVÍA AL FORMULARIO
...
$('.btn-gimg_10').click(function () {
  ...
  document.getElementById("imagen_mostrada_real_vista").src = direccion_archivo + "imgGaleria10.jpg";

});
$('.btn-gimg_11').click(function () {
  ...
  document.getElementById("imagen_mostrada_real_vista").src = direccion_archivo + "imgGaleria11.jpg";

});
$('.btn-gimg_12').click(function () {
  ...
  document.getElementById("imagen_mostrada_real_vista").src = direccion_archivo + "imgGaleria12.jpg";
...
//folleto
    ...
    $("input[name='folleto_visual_1']").on("change", function(){
        ...
        var ruta = "../php/subida_imagenes_CM.php";
        $.ajax({
            xhr: function() {
