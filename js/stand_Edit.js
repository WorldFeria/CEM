$(document).ready(function () {
  ...
  var datos_tabla_stand = function () {
      ...
      "columns": [
        ...
        { "defaultContent": "<div class='d-flex justify-content-center'><button class='btn btn-danger eliminarStand' style='margin:2px'><i class='fa fa-trash' aria-hidden='true'></i></button> </div>" }
        /*{
          "data": "type_stand",
          render: function (data, type, row) {
            var content;
    ...
    borrarStand("#tabla_stand tbody", table);

  }
  var borrarStand = function (tbody, table) {
    $(tbody).on("click", "button.eliminarStand", function () {
      ...
      if(status == 'Sin Asignar'){
        ...
        Swal.fire({
          title: "Está eliminando un stand!",
          ...
          if (result.isConfirmed) {
            ...
            //SE CAMBIA EL NÚMERO TOTAL
            //se elimina el stand

            Swal.fire(
              'El stands han sido borrado!',
              'El stands han sido borrados con exito.',
              'success'
            )
        ...
        Swal.fire({
          title: 'Sólo se pueden borrar stands sin asignar',
          icon: 'warning',
        })
