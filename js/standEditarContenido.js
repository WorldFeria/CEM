  ...
  var datos_tabla_contenidos_stand = function () {
    var table = $('#users_table3').DataTable({
      ...
      "columns": [
        ...
        { "defaultContent": "<div class='d-flex justify-content-center'><button type='button' class='btn btn-danger btn-borrar' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal-ver_imagen' ><i class='fa fa-trash-o' aria-hidden='true'></i></button> </div>" }
