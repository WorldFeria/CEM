$(document).ready(function () {
  ...
  var datos_tabla_stand = function () {
      ...
      "columns": [
        ...
        { "data": "name_stand" },
        {
          ...
          render: function (data, type, row) {
            ...
            if (data == "En espera") {
              ...
              content = `<div class='d-flex justify-content-center'><button type='button' class='btn btn-warning btnReservado'  style='margin:2px''>Apartado <i class="fa fa-pencil-square-o" aria-hidden="true"></i></button> </div>`;
        ...
        { "defaultContent": "<div class='d-flex justify-content-center'><button class='btn btn-primary publi-stand' style='margin:2px'><i class='far fa-edit' aria-='true'></i></button> </div>" },
        ...
        { "defaultContent": "<div class='d-flex justify-content-center'><button type='button' class='btn btn-primary editar' style='margin:2px'><i class='bx bx-palette nav_logo-icon'></i></button> </div>" }
        /*{
          "data": "type_stand",
          render: function (data, type, row) {
            var content;
