...
$colorimgGaleria2 = barraVerde($arrayVerde["data"][7]['subido']);
...
$colorimgGaleria3 = barraVerde($arrayVerde["data"][8]['subido']);
...
$colorimgGaleria4 = barraVerde($arrayVerde["data"][9]['subido']);
...
$colorimgGaleria5 = barraVerde($arrayVerde["data"][10]['subido']);
...
$colorimgGaleria6 = barraVerde($arrayVerde["data"][11]['subido']);
...
$colorimgGaleria7 = barraVerde($arrayVerde["data"][12]['subido']);
...
$colorimgGaleria8 = barraVerde($arrayVerde["data"][13]['subido']);
...
$colorimgGaleria9 = barraVerde($arrayVerde["data"][14]['subido']);
                                ...
                                <td class="col">
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input style="color: transparent; margin-left:30%;"  type="file"" name="fileimg_general" id="fileimg_general" accept="image/png, .jpeg, .jpg">
                                ...
                                <td class="col">
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input style="color: transparent; margin-left:30%;"  type="file"" name="videoPantallaFile" id="videoPantallaFile" accept="video/mp4">
                                            <div class="progress" style="height: 12px; margin:5px 0;">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card  text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent  text-primary">
                        <h5 id="titulo_texto">Subir caratulas </h5>
                    </div>
                    <div>
                            ...
                            <div class="row">
                                <div>
                                    <div class="text-center">
                                        ...
                                        <td>
                                            <input hidden value="folleto3" name="nombre_caratula3" type="text" class="form-control">
                                        </td>
                            ...
                            <div class="row">
                                <div>
                                    <div class="text-center">
                                        ...
                                        <td>
                                            <input hidden value="imgGaleria8" name="nombre_archivoimg8" type="text" class="form-control">
                                        </td>
                                        <td>
                                            <input hidden value="imgGaleria9" name="nombre_archivoimg9" type="text" class="form-control">
                                        </td>
                            ...
                            <tr class="row">
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria1" type="file" name="imgGaleria1" accept="image/png, .jpeg, .jpg">
                                                <div class="progress">
                                    ...
                                    <td class="col">
                                        ...
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria2" type="file" name="imgGaleria2" id="fileimg" accept="image/png, .jpeg, .jpg">
                                    ...
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria3" type="file" name="imgGaleria3" id="fileimg" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 6px; margin:5px 0;">
                                    ...
                                    <td class="col">
                                        ...
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria4" type="file" name="imgGaleria4" id="fileimg" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 6px; margin:5px 0;">
                                    ...
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria5" type="file" name="imgGaleria5" id="fileimg" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 6px; margin:5px 0;">
                                    ...
                                    <td class="col">
                                        ...
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria6" type="file" name="imgGaleria6" id="fileimg" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 6px; margin:5px 0;">
                                ...
                                <tr class="row">
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria7" type="file" name="imgGaleria7" id="fileimg" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 6px; margin:5px 0;">
                                    ...
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                <label id="cambiar_subir" class="col-form-label w-100">Cambiar o subir imagen 8 de la galería</label>
                                                <?php echo $etiquetaimgGaleria8; ?>
                                                <input style="color: transparent; margin-left:30%;"  id="imgGaleria8" type="file" name="imgGaleria8" id="fileimg" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 6px; margin:5px 0;">
                                                    <div id="img_uploadbarimgGaleria8" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                            <small id="texto_abajo">La imagen debe tener un tamaño menor o igual 1920x1080 pixeles y debe ser del tipo .jpg, .jpeg o .png</small>
                                        </div>
                                ...
                                <tr class="row">
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                <label id="cambiar_subir" class="col-form-label w-100">Cambiar o subir imagen 9 de la galería</label>
                                                <?php echo $etiquetaimgGaleria9; ?>
                                                <input style="color: transparent; margin-left:30%;" id="imgGaleria9" type="file" name="imgGaleria9" id="fileimg" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 6px; margin:5px 0;">
                                                    <div id="img_uploadbarimgGaleria9" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                            <small id="texto_abajo">La imagen debe tener un tamaño menor o igual 1920x1080 pixeles y debe ser del tipo .jpg, .jpeg o .png</small>
                                        </div>
                                    ...
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                <label id="cambiar_subir" class="col-form-label w-100">Cambiar o subir imagen 8 de la galería</label>
                                                <?php echo $etiquetaimgGaleria8; ?>
                                                <button type='button' class='btn btn-primary btn-gimg_8' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_gimg_8' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-='true'></i>
                                                </button>
                                            </div>
                                    </td>
                                    ...
                                    <td class="col">
                                        <div class="form-group">
                                            <div>
                                                <label id="cambiar_subir" class="col-form-label w-100">Cambiar o subir imagen 9 de la galería</label>
                                                <?php echo $etiquetaimgGaleria9; ?>
                                                <button type='button' class='btn btn-primary btn-gimg_9' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_gimg_9' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-='true'></i>
                                                </button>
                                            </div>
                                    </td>
...
<div class="main_container">
    ...
    <div class="text-center">
        <h2>Contenido del <b>Stand Central : </b> <?php echo $name_stand; ?></h2>
    </div>
    <svi class="container">
        <div class="row">
...
$n_archivos_subidos = $array["data"][0]["n_archivos_subidos"];
$boton_galeria = decidir_boton($n_archivos_subidos, 9);
    ...
    <div class=" col-12 table-responsive">
        <table class="table table-striped table-borderless text-center" id="users_table" style="width:100%">
            <thead>
                ...
                <tr>
                    <td>Imagenes Galería (9 Unidades)</td>
                    <td>1920x1080 C/U</td>
                    <td>
...
<div class="modal fade" id="borrar_video" tabindex="-1" aria-labelledby="exampleModalLabel" aria-="true">
    ...
    <script src="../js/standEditarContenidoCC.js"></script>