			...
			<div class="col-md-3 col-sm-12 col-12">
				<div class="info-box">
					...
					<div class="info-box-content">
						...
						<span class="info-box-text">Visitas a mis stands</span>
					</div>
			...
			<div class="col-md-3 col-sm-12 col-12">
				<div class="info-box">
					...
					<div class="info-box-content">
						...
						<span class="info-box-text">Conectados ahora</span>
					</div>
				...
				<div class="col-md-8 col-sm-12">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12" style="margin-bottom: 24px;">
							...
							<div class="card flex-fill w-100 ">
								<div class="c-card-header ">
									<h5 class="c-card-title mb-0">Visitas al evento en este periodo</h5>
								</div>
						...
						<div class="col-md-6 col-sm-12" style="margin-bottom: 24px;">
							...
							<div class="card flex-fill w-100">
								<div class="c-card-header ">
									<h5 class="c-card-title mb-0">Visitas a mis stands en este periodo</h5>
								</div>
				...
				<div class="col-md-4 col-sm-12" style="margin-bottom: 24px;">
					...
					<div class="card flex-fill w-100">
						...
						<div class="flex-fill">
							...
							<div class="c-card-header ">
								<h5 class="c-card-title mb-0">Mis tipos de stands</h5>
						...
						<div class="flex-fill">
							...
							<div class="c-card-header ">
								<h5 class="c-card-title mb-0">Usuarios que me visitan</h5>
