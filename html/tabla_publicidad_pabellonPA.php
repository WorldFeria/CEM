    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card border-primary text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent border-primary text-primary">
                        <h5 id="titulo_texto">Subir imagenes para el Banner Horizontal 6X3 (11 unidades) </h5>
                    </div>
                    <div>
                                ...
                                <div>
                                    <div class="text-center">
                                        <td>
                                            ...
                                            <input hidden value="PA6X3_6" name="banner6x3_6" class="form-control">
                                            <input hidden value="PA6X3_7" name="banner6x3_7" class="form-control">
                                            <input hidden value="PA6X3_8" name="banner6x3_8" class="form-control">
                                            <input hidden value="PA6X3_9" name="banner6x3_9" class="form-control">
                                            <input hidden value="PA6X3_10" name="banner6x3_10" class="form-control">
                                            <input hidden value="PA6X3_11" name="banner6x3_11" class="form-control">
                            ...
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Horizontal 6X3 (PA6X3_6)</label>
                                                <input type="file" name="banner6x3_6File" id="banner6x3_6File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner6x3_6" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Horizontal 6X3 (PA6X3_7)</label>
                                                <input type="file" name="banner6x3_7File" id="banner6x3_7File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner6x3_7" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                        </td>
                                        ...
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Horizontal 6X3 (PA6X3_8)</label>
                                                <input type="file" name="banner6x3_8File" id="banner6x3_8File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner6x3_8" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Horizontal 6X3 (PA6X3_9)</label>
                                                <input type="file" name="banner6x3_9File" id="banner6x3_9File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner6x3_9" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Horizontal 6X3 (PA6X3_10)</label>
                                                <input type="file" name="banner6x3_10File" id="banner6x3_10File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner6x3_10" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Horizontal 6X3 (PA6X3_11)</label>
                                                <input type="file" name="banner6x3_11File" id="banner6x3_11File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner6x3_11" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card border-primary text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent border-primary text-primary">
                        <h5 id="titulo_texto">Editar Banner Horizontal 6X3 (11 unidades) </h5>
                    </div>
                    <div>
                        <div id="respuesta_img_banner6x3"></div>
                        <form id="formulario_banner6x3" enctype="multipart/form-data">
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Horizontal 6X3 (PA6X3_6)</label>
                                                <button type='button' class='btn btn-primary btn-vista_horizontal6x3_6' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_horizontal6x3_6' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Horizontal 6X3 (PA6X3_7)</label>
                                                <button type='button' class='btn btn-primary btn-vista_horizontal6x3_7' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_horizontal6x3_7' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Horizontal 6X3 (PA6X3_8)</label>
                                                <button type='button' class='btn btn-primary btn-vista_horizontal6x3_8' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_horizontal6x3_8' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Horizontal 6X3 (PA6X3_9)</label>
                                                <button type='button' class='btn btn-primary btn-vista_horizontal6x3_9' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_horizontal6x3_9' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Horizontal 6X3 (PA6X3_10)</label>
                                                <button type='button' class='btn btn-primary btn-vista_horizontal6x3_10' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_horizontal6x3_10' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Horizontal 6X3 (PA6X3_11)</label>
                                                <button type='button' class='btn btn-primary btn-vista_horizontal6x3_11' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_horizontal6x3_11' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card border-primary text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent border-primary text-primary">
                        <h5 id="titulo_texto">Subir imagenes para el Banner Vertical 2.5X3 (4 unidades) </h5>
                    </div>
                    <div>
                                ...
                                <div>
                                    <div class="text-center">
                                        <td>
                                            ...
                                            <input hidden value="PA2.5X3_3" name="banner25x3_3" class="form-control">
                                            <input hidden value="PA2.5X3_4" name="banner25x3_4" class="form-control">
                                            <input hidden value="<?php echo $id_pabellon_padre; ?>" name="codigo_pabellon_padre" class="form-control">
                                        </td>
                                    </div>
                                </div>
                            ...
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Vertical 2.5X3 (PA2.5X3_3)</label>
                                                <input type="file" name="banner25x3_3File" id="banner25x3_3File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner25x3_3" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Cambiar o subir archivo para el Banner Vertical 2.5X3 (PA2.5X3_4)</label>
                                                <input type="file" name="banner25x3_4File" id="banner25x3_4File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_banner25x3_4" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                            ...
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Vertical 2.5X3 (PA2.5X3_3)</label>
                                                <button type='button' class='btn btn-primary btn-vista_vertical25x3_3' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Banner Vertical 2.5X3 (PA2.5X3_4)</label>
                                                <button type='button' class='btn btn-primary btn-vista_vertical25x3_4' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card border-primary text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent border-primary text-primary">
                        <h5 id="titulo_texto">Subir imagenes para Cajas de Luz (10 unidades) </h5>
                    </div>
                    <div>
                                ...
                                <div>
                                    <div class="text-center">
                                        <td>
                                            ...
                                            <input hidden value="PACL9" name="cajaluz_9" class="form-control">
                                            <input hidden value="PACL10" name="cajaluz_10" class="form-control">
                                            <input hidden id="id_auditorio_padre" value="<?php echo $id_pabellon_padre; ?>" name="codigo_pabellon_padre" class="form-control">
                                        </td>
                                    </div>
                                </div>
                            ...
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Caja Luz 9 (PACL9)</label>
                                                <input type="file" name="cajaluz_9File" id="cajaluz_9File" accept="image/PAg, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_cajaluz_9" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Caja Luz 10 (PACL10)</label>
                                                <input type="file" name="cajaluz_10File" id="cajaluz_10File" accept="image/PAg, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_cajaluz_10" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card border-primary text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent border-primary text-primary">
                        <h5 id="titulo_texto">Editar Cajas de Luz (10 unidades) </h5>
                    </div>
                    <div>
                        <div id="respuesta_img_cajaluz"></div>
                        <form id="formulario_cajaluz" enctype="multipart/form-data">
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Caja Luz 9 (PACL9)</label>
                                                <button type='button' class='btn btn-primary btn_vista_cajaluz_9' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_cajaluz_9' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Caja Luz 10 (PACL10)</label>
                                                <button type='button' class='btn btn-primary btn_vista_cajaluz_10' style='margin:2px' data-bs-toggle='modal' data-bs-target='.modal_vista_previa'>
                                                    <i class='fa fa-eye' aria-hidden='true'></i>
                                                </button>
                                                <button type='button' class='btn btn-danger btn-borrar_cajaluz_10' style='margin:2px' data-bs-toggle='modal' data-bs-target='#borrar_imagen'>
                                                    <i class='fa fa-trash-o' aria-hidden='true'></i>
                                                </button>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card border-primary text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent border-primary text-primary">
                        <h5 id="titulo_texto">Subir imagenes para Plumas (28 unidades) </h5>
                    </div>
                    <div>
                                ...
                                <div>
                                    <div class="text-center">
                                        <td>
                                            ...
                                            <input hidden value="PAPL13" name="pluma_13" class="form-control">
                                            <input hidden value="PAPL14" name="pluma_14" class="form-control">
                                            <input hidden value="PAPL15" name="pluma_15" class="form-control">
                                            <input hidden value="PAPL16" name="pluma_16" class="form-control">
                                            <input hidden value="PAPL17" name="pluma_17" class="form-control">
                                            <input hidden value="PAPL18" name="pluma_18" class="form-control">
                                            <input hidden value="PAPL19" name="pluma_19" class="form-control">
                                            <input hidden value="PAPL20" name="pluma_20" class="form-control">
                                            <input hidden value="PAPL21" name="pluma_21" class="form-control">
                                            <input hidden value="PAPL22" name="pluma_22" class="form-control">
                                            <input hidden value="PAPL23" name="pluma_23" class="form-control">
                                            <input hidden value="PAPL24" name="pluma_24" class="form-control">
                                            <input hidden value="PAPL25" name="pluma_25" class="form-control">
                                            <input hidden value="PAPL26" name="pluma_26" class="form-control">
                                            <input hidden value="PAPL27" name="pluma_27" class="form-control">
                                            <input hidden value="PAPL28" name="pluma_28" class="form-control">
                                            <input hidden id="id_auditorio_padre" value="<?php echo $id_pabellon_padre; ?>" name="codigo_pabellon_padre" class="form-control">
                                        </td>
                                    </div>
                                </div>
                            ...
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 13 (PAPL13)</label>
                                                <input type="file" name="pluma_13File" id="pluma_13File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_13" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 14 (PAPL14)</label>
                                                <input type="file" name="pluma_14File" id="pluma_14File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_14" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 15 (PAPL15)</label>
                                                <input type="file" name="pluma_15File" id="pluma_15File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_15" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 16 (PAPL16)</label>
                                                <input type="file" name="pluma_16File" id="pluma_16File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_16" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 17 (PAPL17)</label>
                                                <input type="file" name="pluma_17File" id="pluma_17File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_17" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 18 (PAPL18)</label>
                                                <input type="file" name="pluma_18File" id="pluma_6File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_18" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 19 (PAPL19)</label>
                                                <input type="file" name="pluma_19File" id="pluma_19File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_19" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 20 (PAPL20)</label>
                                                <input type="file" name="pluma_20File" id="pluma_20File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_20" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 21 (PAPL21)</label>
                                                <input type="file" name="pluma_21File" id="pluma_21File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_21" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 22 (PAPL22)</label>
                                                <input type="file" name="pluma_22File" id="pluma_22File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_22" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 23 (PAPL23)</label>
                                                <input type="file" name="pluma_23File" id="pluma_23File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_23" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 24 (PAPL24)</label>
                                                <input type="file" name="pluma_24File" id="pluma_24File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_24" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 25 (PAPL25)</label>
                                                <input type="file" name="pluma_25File" id="pluma_25File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_25" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 26 (PAPL26)</label>
                                                <input type="file" name="pluma_26File" id="pluma_26File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_26" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 27 (PAPL27)</label>
                                                <input type="file" name="pluma_27File" id="pluma_27File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_27" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Subir Pluma 28 (PAPL28)</label>
                                                <input type="file" name="pluma_28File" id="pluma_28File" accept="image/png, .jpeg, .jpg">
                                                <div class="progress" style="height: 12px; margin:5px 0;">
                                                    <div id="img_uploadbar_pluma_28" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="card border-primary text-center shadow p-3 mb-4 rounded">
                    <div class="card-header bg-transparent border-primary text-primary">
                        <h5 id="titulo_texto">Editar Plumas (28 unidades) </h5>
                    </div>
                    <div>
                        <div id="respuesta_img_banner25x3"></div>
                        <form id="formulario_banner25x3" enctype="multipart/form-data">
                            <table cellspacing="4" cellpadding="5">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 13 (PAPL1)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 14 (PAPL14)</label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 15 (PAPL15)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 16 (PAPL4)</label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 17 (PAPL17)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 18 (PAPL18)</label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 19 (PAPL19)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 20 (PAPL20)</label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 21 (PAPL21)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 22 (PAPL22)</label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 23 (PAPL23)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 24 (PAPL24)</label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 25 (PAPL25)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 26 (PAPL26)</label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 27 (PAPL27)</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div>
                                                <label class="col-form-label w-100">Pluma 28 (PAPL28)</label>
...
<script src="../js/tabla_PA.js"></script>
